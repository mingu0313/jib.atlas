...
function CanvasSkeleton() {
  return (
    <div className="flex h-[300px] w-full max-w-[800px] items-center justify-center rounded-2xl border border-border bg-surface text-sm text-muted sm:h-[600px]">
      캔버스 불러오는 중…
    </div>
  );
}
...
export default function EditorPage() {
  ...
  return (
    <main className="mx-auto flex min-h-screen max-w-4xl flex-col gap-6 p-6 sm:p-10">
      ...
      <div className="flex flex-wrap items-center justify-between gap-3 rounded-2xl border border-border bg-surface p-3 text-sm">
        ...
        <button
          ...
          className="text-muted underline underline-offset-2 disabled:opacity-40"
        >
          전체 비우기
        </button>
      </div>
